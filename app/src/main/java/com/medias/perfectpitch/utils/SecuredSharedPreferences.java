 ...
 * <p>
 * Updated usage:
 * SecuredSharedPreferences prefs = SecuredSharedPreferences.getPrefs(this, MY_APP_NAME, Context.MODE_PRIVATE);
 * //to get data
...
public class SecuredSharedPreferences implements SharedPreferences {
     ...
     */
    public SecuredSharedPreferences(Context context, SharedPreferences delegate) {
        this.delegate = delegate;
        this.context = context;
        //updated thanks to help from bkhall on github
        SecuredSharedPreferences.setNewKey(Settings.Secure.getString(context.getContentResolver(), Settings.Secure.ANDROID_ID));
        SecuredSharedPreferences.setNewSalt(Settings.Secure.getString(context.getContentResolver(), Settings.Secure.ANDROID_ID));
    }
     ...
     * @return
     */
    public synchronized static SecuredSharedPreferences getPrefs(Context c, String domainName, int contextMode) {
        ...
        SecuredSharedPreferences prefs = new SecuredSharedPreferences(
    ...
    public class Editor implements SharedPreferences.Editor {
        ...
        public Editor() {
            this.delegate = SecuredSharedPreferences.this.delegate.edit();
        }
